...
export function setCard() {
    ...
    cardNode.classList.remove('fade'); // Remove the fade class from the card
    cardNode.parentElement.classList.remove('flip'); // Remove the flip class f
}
...
export function showCard() {
     ...
     */
    const cardNode = getCardNode();
    cardNode.classList.remove('hidden'); // Make sure the card is visible
    cardNode.classList.add('fade'); // Add the fade animation class
    cardNode.parentElement.classList.add('flip'); // Add the flip animation to the parent
